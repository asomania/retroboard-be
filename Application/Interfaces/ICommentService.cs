...
public interface ICommentService
{
    ...
    Task<CommentResponse?> CreateCommentAsync(string boardId, string columnId, string cardId, CommentCreateRequest request, string currentUserId, CancellationToken cancellationToken = default);
